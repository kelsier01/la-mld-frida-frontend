    ...
    <ion-page>
        <ion-header>
            <ion-toolbar>
                ...
                <ion-title>Gestion Chile - Despacho</ion-title>
            </ion-toolbar>
        </ion-header>
        ...
        <ion-content class="ion-padding">
            <ion-tabs>
                ...
                <ion-tab-bar slot="bottom">
                    <ion-tab-button tab="home" href="/gestionChile">
                        <ion-icon :icon="downloadOutline" />
                        <ion-label>Recepcion</ion-label>
                    </ion-tab-button>

                    <ion-tab-button tab="radio" href="/gestionChile/despacho">
                        <ion-icon :icon="rocketOutline" />
                        <ion-label>Despacho</ion-label>
                    </ion-tab-button>

                    <ion-tab-button tab="library" href="/gestionChile/entrega">
...
import { ref } from 'vue';
import { cardOutline, checkmarkDone, downloadOutline, pencil, rocketOutline, trashOutline } from 'ionicons/icons';
