          ...
          <ion-list>
            <ion-item v-for="bodega in producto?.ProductoBodegas" :key="bodega">
              ...
              <ion-buttons slot="end">
                ...
                <ion-button
                  @click="confirmarEliminarStock(String(bodega.id))"
                  color="danger"
                >
                  <ion-icon :icon="trashOutline" slot="icon-only"></ion-icon>
                </ion-button>
    ...
    <ion-modal :is-open="modalEditarAbierto" @didDismiss="cerrarModalEditar">
      ...
      <ion-content class="ion-padding">
        ...
        <ion-item>
          ...
          >
            <ion-select-option value="electronica"
              >Electrónica</ion-select-option
            >
...
const agregarStock = () => {
  //producto.value.stockPorBodega[nuevoStock.value.bodega] =
  nuevoStock.value.cantidad; // Agregar nuevo stock
...
const guardarCambiosStock = () => {
  //producto.value.stockPorBodega[bodegaEditada.value] =
  stockEditado.value.cantidad; // Actualizar stock
